...
- user stories
  - the game will open with a picture of a chalkboard that has the 5 enlgish vowels and their corresponding parts in hiragana and         katakana. There will also be some text "ready to test your memory?" and a button "ready!"
  - once the user presses the button the chalk board disappears and is replaced by 15 cards
  - 5 of the cards are lined up horizontally on the top and then the ten cards are underneath the five in horizontal rows
